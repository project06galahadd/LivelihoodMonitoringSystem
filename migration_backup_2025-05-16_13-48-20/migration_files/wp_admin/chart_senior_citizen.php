              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <?php
                    ...
                    $sqlchart="SELECT *,COUNT(m.GENDER) As TotalGender, SUM(CASE WHEN m.GENDER = 'MALE' THEN 1 ELSE 0 END)AS MSEX, SUM(CASE WHEN m.GENDER = 'FEMALE' THEN 1 ELSE 0 END) AS FSEX, b.BRGY_NAME FROM tbl_barangay b LEFT JOIN tbl_members m ON b.BRGY_NAME=m.BARANGAY WHERE AGE >=50  GROUP BY b.BRGY_NAME ORDER BY TotalGender DESC";
          ...
          <div class="col-md-9">
            <div class="card">
              <div class="card-header">
               <h3 class="card-title"> 
                 SENIOR CITIZEN MALE AND FEMALE REPORT PER BARANGAY
                </h3>
              ...
              error_reporting(0);
                  ...
                  $sql = "SELECT *,SUM(CASE WHEN m.GENDER = 'MALE' THEN 1 ELSE 0 END)AS MSEX, SUM(CASE WHEN m.GENDER = 'FEMALE' THEN 1 ELSE 0 END) AS FSEX, m.BARANGAY FROM tbl_members m WHERE m.AGE >=50 GROUP BY m.BARANGAY";
