...
if (isset($_GET['error'])) {
    $_SESSION['error'] = 'Invalid recovery code';
}
?>
...
<head>
    ...
    <title>Verify Recovery Code - MSWD Admin Portal</title>
    <style>
        :root {
...
<body>
    <div class="admin-login-container">
        <div class="admin-header">
            ...
            <p class="admin-subtitle">Enter Recovery Code</p>
        </div>
        ...
        <form method="POST" action="verify_recovery_code.php">
            <div class="admin-form-group">
                <input type="text" name="recovery_code" class="admin-input" placeholder="Enter 6-digit code" maxlength="6" required>
            </div>
