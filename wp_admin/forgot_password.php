...
<head>
    ...
    <title>Forgot Password - MSWD Admin Portal</title>
    <style>
        :root {
...
<body>
    <div class="admin-login-container">
        <div class="admin-header">
            ...
            <p class="admin-subtitle">Password Recovery</p>
        </div>
        ...
        <form method="POST" action="send_recovery_code.php">
            <div class="admin-form-group">
                <i class="fas fa-envelope"></i>
                <input type="email" name="email" class="admin-input" placeholder="Enter your registered email" required>
            </div>
