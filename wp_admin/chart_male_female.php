              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <?php
                    ...
                    $sqlchart="SELECT *,SUM(CASE WHEN m.GENDER = 'MALE' THEN 1 ELSE 0 END)AS MSEX, SUM(CASE WHEN m.GENDER = 'FEMALE' THEN 1 ELSE 0 END) AS FSEX, b.BRGY_NAME FROM tbl_barangay b LEFT JOIN tbl_members m ON b.BRGY_NAME=m.BARANGAY GROUP BY b.BRGY_NAME";
                    ...
                    if($cquery->num_rows >0){
                      while($rowchart=$cquery->fetch_assoc()){
                        ...
                        echo ' <li class="list-group-item">
                          '.$rowchart['BRGY_NAME'].'<a class="float-right">M '.$totalMale.' / F '.$totalFMale.'</a>
                          </li>';
                      }
                    }else{
                        echo '<li class="list-group-item">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              error_reporting(0);
                  ...
                  $sql = "SELECT *,SUM(CASE WHEN m.GENDER = 'MALE' THEN 1 ELSE 0 END)AS MSEX, SUM(CASE WHEN m.GENDER = 'FEMALE' THEN 1 ELSE 0 END) AS FSEX, b.BRGY_NAME FROM tbl_barangay b LEFT JOIN tbl_members m ON b.BRGY_NAME=m.BARANGAY GROUP BY b.BRGY_NAME";
                  $query = $db->prepare($sql); 
                  $query->execute();
                  $fetch = $query->fetchAll();
                  foreach ($fetch as $key => $value) {
                    $female[] = array('Title'=>$value['BRGY_NAME'], 'Female'=>$value['FSEX'], 'Male'=>$value['MSEX']);
                  }
